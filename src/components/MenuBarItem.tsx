...
export function MenuBarItem({
  ...
  return (
    <ButtonNaked
      ...
      className="group relative flex h-14 flex-1 cursor-pointer flex-row items-center px-4 hover:bg-primary-accent/30 w-full md:mt-2 md:flex-none md:rounded-lg md:last:mt-auto"
      onPress={() => {
